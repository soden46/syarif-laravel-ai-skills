...
Use this skill when a Laravel task involves e2e playwright.

This skill is adapted to the personal Laravel standards in this repository. It maps the public `e2e-playwright` topic from `jpcaparas/superpowers-laravel` into the local `e2e-playwright` catalog without copying third-party skill body text.
