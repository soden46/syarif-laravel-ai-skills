...
Use this skill when a Laravel task involves using laravel superpowers.

This skill is adapted to the personal Laravel standards in this repository. It maps the public `using-laravel-superpowers` topic from `jpcaparas/superpowers-laravel` into the local `using-laravel-superpowers` catalog without copying third-party skill body text.
