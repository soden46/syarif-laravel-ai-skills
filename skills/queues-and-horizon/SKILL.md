...
Use this skill when a Laravel task involves queues and horizon.

This skill is adapted to the personal Laravel standards in this repository. It maps the public `queues-and-horizon` topic from `jpcaparas/superpowers-laravel` into the local `queues-and-horizon` catalog without copying third-party skill body text.
