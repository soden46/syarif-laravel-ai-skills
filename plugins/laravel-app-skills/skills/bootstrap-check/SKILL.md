...
Use this skill when a Laravel task involves bootstrap check.

This skill is adapted to the personal Laravel standards in this repository. It maps the public `bootstrap-check` topic from `jpcaparas/superpowers-laravel` into the local `bootstrap-check` catalog without copying third-party skill body text.
