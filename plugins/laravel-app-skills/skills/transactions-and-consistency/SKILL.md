...
This skill is adapted to the personal Laravel standards in this repository. It maps the public `transactions-and-consistency` topic from `jpcaparas/superpowers-laravel` into the local `transactions-and-consistency` catalog without copying third-party skill body text.
