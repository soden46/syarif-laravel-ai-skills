# Laravel Skills Cloud Mapping / Mapping Laravel Skills Cloud
...
This document tracks supplemental topics mapped from public Laravel Skills Cloud pages into this repository's local skill catalog.

These local skills are not copied from third-party skill bodies. They adapt the topic coverage into this repository's personal Laravel standards, validation rules, and skill-routing style.
...
| Public topic | Local skill | Local folder | Mapping note |
| --- | --- | --- | --- |
...
Dokumen ini melacak topik tambahan yang dimapping dari halaman publik Laravel Skills Cloud ke katalog skill lokal di repository ini.

Skill lokal ini tidak menyalin body skill pihak ketiga. Isinya mengadaptasi cakupan topik ke standar Laravel pribadi, aturan validasi, dan gaya routing skill di repository ini.
...
| Topik publik | Skill lokal | Folder lokal | Catatan mapping |
| --- | --- | --- | --- |
